...
namespace custom_trajectory_controller
{
    ...
    Dynamics getDynamics(const Eigen::Matrix<double, 6, 1>& q)
    {
        ...
        static const double lx3 = -0.425; // original
        //static const double lx3 = 0.425;
        static const double lx4 = -0.39225; // original
        ...
        static const double l4 = 16.34e-3;
        ...
        Dynamics dyn;
        dyn.G << 0,
            g*m5*(lx4*cos(q_2 + q_3) + lx3*cos(q_2) - 1.0*ly5*(cos(q_2 + q_3)*sin(q_4) + sin(q_2 + q_3)*cos(q_4)) - 1.0*l4*sin(q_5)*(cos(q_2 + q_3)*cos(q_4) - 1.0*sin(q_2 + q_3)*sin(q_4))) + g*m6*(lx4*cos(q_2 + q_3) + lx3*cos(q_2) - 1.0*ly5*(cos(q_2 + q_3)*sin(q_4) + sin(q_2 + q_3)*cos(q_4)) - 1.0*ly6*sin(q_5)*(cos(q_2 + q_3)*cos(q_4) - 1.0*sin(q_2 + q_3)*sin(q_4))) + g*m4*(lx4*cos(q_2 + q_3) + lx3*cos(q_2) + l4*(cos(q_2 + q_3)*sin(q_4) + sin(q_2 + q_3)*cos(q_4))) + g*m3*(l3*cos(q_2 + q_3) + lx3*cos(q_2)) + g*l1*m2*cos(q_2),
            g*m4*(lx4*cos(q_2 + q_3) + l4*sin(q_2 + q_3 + q_4)) - 1.0*g*m5*(ly5*sin(q_2 + q_3 + q_4) - 1.0*lx4*cos(q_2 + q_3) + l4*cos(q_2 + q_3 + q_4)*sin(q_5)) - 1.0*g*m6*(ly5*sin(q_2 + q_3 + q_4) - 1.0*lx4*cos(q_2 + q_3) + ly6*cos(q_2 + q_3 + q_4)*sin(q_5)) + g*l3*m3*cos(q_2 + q_3),
            g*l4*m4*sin(q_2 + q_3 + q_4) - 1.0*g*m6*(ly5*sin(q_2 + q_3 + q_4) + ly6*cos(q_2 + q_3 + q_4)*sin(q_5)) - 1.0*g*m5*(ly5*sin(q_2 + q_3 + q_4) + l4*cos(q_2 + q_3 + q_4)*sin(q_5)),
            -1.0*g*sin(q_2 + q_3 + q_4)*cos(q_5)*(l4*m5 + ly6*m6),
            0;

        // mass matrix
        dyn.M << m4*pow((lx4*cos(q_2 + q_3)*sin(q_1) - 1.0*lz4*cos(q_1) + lx3*cos(q_2)*sin(q_1) + l4*sin(q_2 + q_3 + q_4)*sin(q_1)),2) + m5*pow((lz4*sin(q_1) + lx4*cos(q_2 + q_3)*cos(q_1) + lx3*cos(q_1)*cos(q_2) + l4*cos(q_5)*sin(q_1) - 1.0*ly5*sin(q_2 + q_3 + q_4)*cos(q_1) - 1.0*l4*cos(q_2 + q_3 + q_4)*cos(q_1)*sin(q_5)),2) + m6*pow((lz4*sin(q_1) + lx4*cos(q_2 + q_3)*cos(q_1) + lx3*cos(q_1)*cos(q_2) + ly6*cos(q_5)*sin(q_1) - 1.0*ly5*sin(q_2 + q_3 + q_4)*cos(q_1) - 1.0*ly6*cos(q_2 + q_3 + q_4)*cos(q_1)*sin(q_5)),2) + m2*(pow(l1,2) - 1.0*pow(l1,2)*pow(sin(q_2),2) + pow(l2,2)) + m5*pow((lz4*cos(q_1) - 1.0*lx4*cos(q_2 + q_3)*sin(q_1) + l4*cos(q_1)*cos(q_5) - 1.0*lx3*cos(q_2)*sin(q_1) + ly5*sin(q_2 + q_3 + q_4)*sin(q_1) + l4*cos(q_2 + q_3 + q_4)*sin(q_1)*sin(q_5)),2) + m6*pow((lz4*cos(q_1) - 1.0*lx4*cos(q_2 + q_3)*sin(q_1) + ly6*cos(q_1)*cos(q_5) - 1.0*lx3*cos(q_2)*sin(q_1) + ly5*sin(q_2 + q_3 + q_4)*sin(q_1) + ly6*cos(q_2 + q_3 + q_4)*sin(q_1)*sin(q_5)),2) + m3*pow((l3*cos(q_2 + q_3) + lx3*cos(q_2)),2) + m4*pow((lz4*sin(q_1) + lx4*cos(q_2 + q_3)*cos(q_1) + lx3*cos(q_1)*cos(q_2) + l4*sin(q_2 + q_3 + q_4)*cos(q_1)),2),                                                                                                                                                                                                                                                                                                                                 - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + lx3*sin(q_2) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + lx3*sin(q_2) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*lz4*m4*(lx4*sin(q_2 + q_3) + lx3*sin(q_2) - 1.0*l4*cos(q_2 + q_3 + q_4)) - 1.0*l1*l2*m2*sin(q_2),                                                                                                                                                                                                                                                                                                                                                   - 1.0*lz4*m4*(lx4*sin(q_2 + q_3) - 1.0*l4*cos(q_2 + q_3 + q_4)) - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   l4*lz4*m4*cos(q_2 + q_3 + q_4) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)),                                                                                                                                                                       - 1.0*l4*m5*(0.5*lx3*sin(q_2 - 1.0*q_5) - 0.5*ly5*cos(q_2 + q_3 + q_4 + q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 + q_5) - 0.5*lx3*sin(q_2 + q_5) + 0.5*lx4*sin(q_2 + q_3 - 1.0*q_5) + l4*cos(q_2 + q_3 + q_4) - 0.5*lx4*sin(q_2 + q_3 + q_5) + 0.5*ly5*cos(q_2 + q_3 + q_4 - 1.0*q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*ly6*m6*(0.5*lx3*sin(q_2 - 1.0*q_5) - 0.5*ly5*cos(q_2 + q_3 + q_4 + q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 + q_5) - 0.5*lx3*sin(q_2 + q_5) + 0.5*lx4*sin(q_2 + q_3 - 1.0*q_5) + ly6*cos(q_2 + q_3 + q_4) - 0.5*lx4*sin(q_2 + q_3 + q_5) + 0.5*ly5*cos(q_2 + q_3 + q_4 - 1.0*q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 - 1.0*q_5)), 0,
            - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + lx3*sin(q_2) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + lx3*sin(q_2) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*lz4*m4*(lx4*sin(q_2 + q_3) + lx3*sin(q_2) - 1.0*l4*cos(q_2 + q_3 + q_4)) - 1.0*l1*l2*m2*sin(q_2), pow(l1,2)*m2 + pow(l3,2)*m3 + pow(l4,2)*m4 + 0.5*pow(l4,2)*m5 + pow(lx3,2)*m3 + pow(lx3,2)*m4 + pow(lx3,2)*m5 + pow(lx4,2)*m4 + pow(lx3,2)*m6 + pow(lx4,2)*m5 + pow(lx4,2)*m6 + pow(ly5,2)*m5 + pow(ly5,2)*m6 + 0.5*pow(ly6,2)*m6 - 0.5*pow(l4,2)*m5*cos(2.0*q_5) - 0.5*pow(ly6,2)*m6*cos(2.0*q_5) + 2.0*l4*lx3*m4*sin(q_3 + q_4) - 1.0*l4*lx4*m5*sin(q_4 + q_5) - 2.0*lx3*ly5*m5*sin(q_3 + q_4) - 2.0*lx3*ly5*m6*sin(q_3 + q_4) - 1.0*lx4*ly6*m6*sin(q_4 + q_5) + l4*lx3*m5*sin(q_3 + q_4 - 1.0*q_5) + lx3*ly6*m6*sin(q_3 + q_4 - 1.0*q_5) + 2.0*l3*lx3*m3*cos(q_3) + 2.0*lx3*lx4*m4*cos(q_3) + 2.0*lx3*lx4*m5*cos(q_3) + 2.0*lx3*lx4*m6*cos(q_3) + 2.0*l4*lx4*m4*sin(q_4) - 2.0*lx4*ly5*m5*sin(q_4) - 2.0*lx4*ly5*m6*sin(q_4) - 1.0*l4*lx3*m5*sin(q_3 + q_4 + q_5) - 1.0*lx3*ly6*m6*sin(q_3 + q_4 + q_5) + l4*lx4*m5*sin(q_4 - 1.0*q_5) + lx4*ly6*m6*sin(q_4 - 1.0*q_5), pow(l3,2)*m3 + pow(l4,2)*m4 + pow(l4,2)*m5 + pow(lx4,2)*m4 + pow(lx4,2)*m5 + pow(lx4,2)*m6 + pow(ly5,2)*m5 + pow(ly5,2)*m6 + pow(ly6,2)*m6 - 1.0*pow(l4,2)*m5*pow(cos(q_5),2) - 1.0*pow(ly6,2)*m6*pow(cos(q_5),2) + l4*lx3*m4*sin(q_3 + q_4) + l3*lx3*m3*cos(q_3) + lx3*lx4*m4*cos(q_3) + lx3*lx4*m5*cos(q_3) + lx3*lx4*m6*cos(q_3) + 2.0*l4*lx4*m4*sin(q_4) - 2.0*lx4*ly5*m5*sin(q_4) - 2.0*lx4*ly5*m6*sin(q_4) - 2.0*l4*lx4*m5*cos(q_4)*sin(q_5) - 1.0*lx3*ly5*m5*cos(q_3)*sin(q_4) - 1.0*lx3*ly5*m5*cos(q_4)*sin(q_3) - 1.0*lx3*ly5*m6*cos(q_3)*sin(q_4) - 1.0*lx3*ly5*m6*cos(q_4)*sin(q_3) - 2.0*lx4*ly6*m6*cos(q_4)*sin(q_5) - 1.0*l4*lx3*m5*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*lx3*ly6*m6*cos(q_3)*cos(q_4)*sin(q_5) + l4*lx3*m5*sin(q_3)*sin(q_4)*sin(q_5) + lx3*ly6*m6*sin(q_3)*sin(q_4)*sin(q_5),                                                                                                                                                                                                                                                                                                 l4*m4*(l4 + lx3*sin(q_3 + q_4) + lx4*sin(q_4)) - 1.0*m6*(pow(ly6,2)*pow(cos(q_5),2) - 1.0*pow(ly5,2) - 1.0*pow(ly6,2) + lx4*ly5*sin(q_4) + lx3*ly5*cos(q_3)*sin(q_4) + lx3*ly5*cos(q_4)*sin(q_3) + lx4*ly6*cos(q_4)*sin(q_5) + lx3*ly6*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*lx3*ly6*sin(q_3)*sin(q_4)*sin(q_5)) - 1.0*m5*(pow(l4,2)*pow(cos(q_5),2) - 1.0*pow(l4,2) - 1.0*pow(ly5,2) + lx4*ly5*sin(q_4) + l4*lx4*cos(q_4)*sin(q_5) + lx3*ly5*cos(q_3)*sin(q_4) + lx3*ly5*cos(q_4)*sin(q_3) + l4*lx3*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*l4*lx3*sin(q_3)*sin(q_4)*sin(q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                -1.0*cos(q_5)*(l4*m5 + ly6*m6)*(lx3*sin(q_3 + q_4) - 1.0*ly5 + lx4*sin(q_4)), 0,
            - 1.0*lz4*m4*(lx4*sin(q_2 + q_3) - 1.0*l4*cos(q_2 + q_3 + q_4)) - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + lx4*sin(q_2 + q_3) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)),                                                    pow(l3,2)*m3 + pow(l4,2)*m4 + pow(l4,2)*m5 + pow(lx4,2)*m4 + pow(lx4,2)*m5 + pow(lx4,2)*m6 + pow(ly5,2)*m5 + pow(ly5,2)*m6 + pow(ly6,2)*m6 - 1.0*pow(l4,2)*m5*pow(cos(q_5),2) - 1.0*pow(ly6,2)*m6*pow(cos(q_5),2) + l4*lx3*m4*sin(q_3 + q_4) + l3*lx3*m3*cos(q_3) + lx3*lx4*m4*cos(q_3) + lx3*lx4*m5*cos(q_3) + lx3*lx4*m6*cos(q_3) + 2.0*l4*lx4*m4*sin(q_4) - 2.0*lx4*ly5*m5*sin(q_4) - 2.0*lx4*ly5*m6*sin(q_4) - 2.0*l4*lx4*m5*cos(q_4)*sin(q_5) - 1.0*lx3*ly5*m5*cos(q_3)*sin(q_4) - 1.0*lx3*ly5*m5*cos(q_4)*sin(q_3) - 1.0*lx3*ly5*m6*cos(q_3)*sin(q_4) - 1.0*lx3*ly5*m6*cos(q_4)*sin(q_3) - 2.0*lx4*ly6*m6*cos(q_4)*sin(q_5) - 1.0*l4*lx3*m5*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*lx3*ly6*m6*cos(q_3)*cos(q_4)*sin(q_5) + l4*lx3*m5*sin(q_3)*sin(q_4)*sin(q_5) + lx3*ly6*m6*sin(q_3)*sin(q_4)*sin(q_5),                                                                                                                                                                                                                                                                                                                                                                                                                                           m4*(pow(l4,2) + 2.0*sin(q_4)*l4*lx4 + pow(lx4,2)) - 1.0*m5*(pow(l4,2)*pow(cos(q_5),2) - 1.0*pow(l4,2) - 1.0*pow(lx4,2) - 1.0*pow(ly5,2) + 2.0*lx4*ly5*sin(q_4) + 2.0*l4*lx4*cos(q_4)*sin(q_5)) - 1.0*m6*(pow(ly6,2)*pow(cos(q_5),2) - 1.0*pow(lx4,2) - 1.0*pow(ly5,2) - 1.0*pow(ly6,2) + 2.0*lx4*ly5*sin(q_4) + 2.0*lx4*ly6*cos(q_4)*sin(q_5)) + pow(l3,2)*m3,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                l4*m4*(l4 + lx4*sin(q_4)) - 1.0*m6*(pow(ly6,2)*pow(cos(q_5),2) - 1.0*pow(ly5,2) - 1.0*pow(ly6,2) + lx4*ly5*sin(q_4) + lx4*ly6*cos(q_4)*sin(q_5)) - 1.0*m5*(pow(l4,2)*pow(cos(q_5),2) - 1.0*pow(l4,2) - 1.0*pow(ly5,2) + lx4*ly5*sin(q_4) + l4*lx4*cos(q_4)*sin(q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cos(q_5)*(ly5 - 1.0*lx4*sin(q_4))*(l4*m5 + ly6*m6), 0,
            l4*lz4*m4*cos(q_2 + q_3 + q_4) - 1.0*m6*(lz4 + ly6*cos(q_5))*(0.5*ly6*cos(q_2 + q_3 + q_4 + q_5) + ly5*cos(q_2 + q_3 + q_4) - 0.5*ly6*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*m5*(lz4 + l4*cos(q_5))*(0.5*l4*cos(q_2 + q_3 + q_4 + q_5) + ly5*cos(q_2 + q_3 + q_4) - 0.5*l4*cos(q_2 + q_3 + q_4 - 1.0*q_5)),                                                                                                                                                                                                                                                               l4*m4*(l4 + lx3*sin(q_3 + q_4) + lx4*sin(q_4)) - 1.0*m6*(pow(ly6,2)*pow(cos(q_5),2) - 1.0*pow(ly5,2) - 1.0*pow(ly6,2) + lx4*ly5*sin(q_4) + lx3*ly5*cos(q_3)*sin(q_4) + lx3*ly5*cos(q_4)*sin(q_3) + lx4*ly6*cos(q_4)*sin(q_5) + lx3*ly6*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*lx3*ly6*sin(q_3)*sin(q_4)*sin(q_5)) - 1.0*m5*(pow(l4,2)*pow(cos(q_5),2) - 1.0*pow(l4,2) - 1.0*pow(ly5,2) + lx4*ly5*sin(q_4) + l4*lx4*cos(q_4)*sin(q_5) + lx3*ly5*cos(q_3)*sin(q_4) + lx3*ly5*cos(q_4)*sin(q_3) + l4*lx3*cos(q_3)*cos(q_4)*sin(q_5) - 1.0*l4*lx3*sin(q_3)*sin(q_4)*sin(q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           l4*m4*(l4 + lx4*sin(q_4)) - 1.0*m6*(pow(ly6,2)*pow(cos(q_5),2) - 1.0*pow(ly5,2) - 1.0*pow(ly6,2) + lx4*ly5*sin(q_4) + lx4*ly6*cos(q_4)*sin(q_5)) - 1.0*m5*(pow(l4,2)*pow(cos(q_5),2) - 1.0*pow(l4,2) - 1.0*pow(ly5,2) + lx4*ly5*sin(q_4) + l4*lx4*cos(q_4)*sin(q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      m5*(pow(l4,2)*pow(sin(q_5),2) + pow(ly5,2)) + m6*(pow(ly5,2) + pow(ly6,2)*pow(sin(q_5),2)) + pow(l4,2)*m4, l4*m5*cos(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*l4*sin(q_2 + q_3 + q_4)*sin(q_5))*(sin(q_1)*sin(q_5) + cos(q_2 + q_3 + q_4)*cos(q_1)*cos(q_5)) + ly6*m6*cos(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*ly6*sin(q_2 + q_3 + q_4)*sin(q_5))*(sin(q_1)*sin(q_5) + cos(q_2 + q_3 + q_4)*cos(q_1)*cos(q_5)) + l4*m5*sin(q_2 + q_3 + q_4)*cos(q_5)*(ly5*sin(q_2 + q_3 + q_4) + l4*cos(q_2 + q_3 + q_4)*sin(q_5)) + ly6*m6*sin(q_2 + q_3 + q_4)*cos(q_5)*(ly5*sin(q_2 + q_3 + q_4) + ly6*cos(q_2 + q_3 + q_4)*sin(q_5)) - 1.0*l4*m5*sin(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*l4*sin(q_2 + q_3 + q_4)*sin(q_5))*(cos(q_1)*sin(q_5) - 1.0*cos(q_2 + q_3 + q_4)*cos(q_5)*sin(q_1)) - 1.0*ly6*m6*sin(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*ly6*sin(q_2 + q_3 + q_4)*sin(q_5))*(cos(q_1)*sin(q_5) - 1.0*cos(q_2 + q_3 + q_4)*cos(q_5)*sin(q_1)), 0,
            - 1.0*l4*m5*(0.5*lx3*sin(q_2 - 1.0*q_5) - 0.5*ly5*cos(q_2 + q_3 + q_4 + q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 + q_5) - 0.5*lx3*sin(q_2 + q_5) + 0.5*lx4*sin(q_2 + q_3 - 1.0*q_5) + l4*cos(q_2 + q_3 + q_4) - 0.5*lx4*sin(q_2 + q_3 + q_5) + 0.5*ly5*cos(q_2 + q_3 + q_4 - 1.0*q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 - 1.0*q_5)) - 1.0*ly6*m6*(0.5*lx3*sin(q_2 - 1.0*q_5) - 0.5*ly5*cos(q_2 + q_3 + q_4 + q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 + q_5) - 0.5*lx3*sin(q_2 + q_5) + 0.5*lx4*sin(q_2 + q_3 - 1.0*q_5) + ly6*cos(q_2 + q_3 + q_4) - 0.5*lx4*sin(q_2 + q_3 + q_5) + 0.5*ly5*cos(q_2 + q_3 + q_4 - 1.0*q_5) + 0.5*lz4*cos(q_2 + q_3 + q_4 - 1.0*q_5)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              -1.0*cos(q_5)*(l4*m5 + ly6*m6)*(lx3*sin(q_3 + q_4) - 1.0*ly5 + lx4*sin(q_4)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     cos(q_5)*(ly5 - 1.0*lx4*sin(q_4))*(l4*m5 + ly6*m6), l4*m5*cos(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*l4*sin(q_2 + q_3 + q_4)*sin(q_5))*(sin(q_1)*sin(q_5) + cos(q_2 + q_3 + q_4)*cos(q_1)*cos(q_5)) + ly6*m6*cos(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*ly6*sin(q_2 + q_3 + q_4)*sin(q_5))*(sin(q_1)*sin(q_5) + cos(q_2 + q_3 + q_4)*cos(q_1)*cos(q_5)) + l4*m5*sin(q_2 + q_3 + q_4)*cos(q_5)*(ly5*sin(q_2 + q_3 + q_4) + l4*cos(q_2 + q_3 + q_4)*sin(q_5)) + ly6*m6*sin(q_2 + q_3 + q_4)*cos(q_5)*(ly5*sin(q_2 + q_3 + q_4) + ly6*cos(q_2 + q_3 + q_4)*sin(q_5)) - 1.0*l4*m5*sin(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*l4*sin(q_2 + q_3 + q_4)*sin(q_5))*(cos(q_1)*sin(q_5) - 1.0*cos(q_2 + q_3 + q_4)*cos(q_5)*sin(q_1)) - 1.0*ly6*m6*sin(q_1)*(ly5*cos(q_2 + q_3 + q_4) - 1.0*ly6*sin(q_2 + q_3 + q_4)*sin(q_5))*(cos(q_1)*sin(q_5) - 1.0*cos(q_2 + q_3 + q_4)*cos(q_5)*sin(q_1)),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          m5*pow(l4,2) + m6*pow(ly6,2), 0,
            0,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         0,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      0,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           0,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           0, 0;
